...
C     Material: CuiJ2CorrosionMaterial
C     Fields: u, phi, c
...
C     --- Tangent arrays ---
      ...
      DOUBLE PRECISION :: dphase_flux_dF(3,3,3)
      DOUBLE PRECISION :: dphase_flux_dgrad_phi(3,3)
      DOUBLE PRECISION :: dphase_flux_dphi(3)
      DOUBLE PRECISION :: dphase_storage_dF(3,3)
      DOUBLE PRECISION :: dphase_storage_dc
      DOUBLE PRECISION :: dphase_storage_dphi
      DOUBLE PRECISION :: dspecies_flux_dF(3,3,3)
      DOUBLE PRECISION :: dspecies_flux_dgrad_c(3,3)
      DOUBLE PRECISION :: dspecies_flux_dgrad_phi(3,3)
      DOUBLE PRECISION :: dspecies_flux_dphi(3)
      DOUBLE PRECISION :: dspecies_storage_dF(3,3)
...
C       Real material evaluation (for RHS)
        ...
        CALL cuij2corrosionmaterial_stress_PK1(Fz_r, phiz_r, ep_old_z,
     &epsp_old_z, deqpl_old_z, hydro_old_z, xL_old_z, ti_old_z,
     &ei_old_z, dt_safe, PROPS, Pz_eval, ep_new_z, epsp_new_z,
     &deqpl_new_z, hydro_new_z, xL_new_z, ti_new_z, ei_new_z)
        DO i = 1, 3
          ...
          END DO
        END DO
        CALL cuij2corrosionmaterial_phase_flux(Fz_r, phiz_r, grad_phi_r,
     & PROPS, phase_fluxz_eval)
        DO i = 1, 3
          phase_flux_real(i) = DBLE(phase_fluxz_eval(i))
        END DO
        CALL cuij2corrosionmaterial_phase_storage(Fz_r, phiz_r, cz_r,
     &DCMPLX(phi_old_gp, 0.0d0), xL_old_z, dt_safe, PROPS,
     &phase_storagez_eval)
        phase_storage_real = DBLE(phase_storagez_eval)
        CALL cuij2corrosionmaterial_species_flux(Fz_r, phiz_r,
     &grad_phi_r, grad_c_r, PROPS, species_fluxz_eval)
        DO i = 1, 3
          species_flux_real(i) = DBLE(species_fluxz_eval(i))
        END DO
        CALL cuij2corrosionmaterial_species_storage(Fz_r, cz_r,
...
C       CS tangent engine
        CALL cuij2corrosionmaterial_cs_tangents(F, c_gp, phi_gp,
     &     grad_c, grad_phi, F_old, phi_old_gp, c_old_gp, ep_old,
     &     epsp_old, deqpl_old, hydro_old, xL_old, ti_old, ei_old,
     &     PROPS, dt_safe, dPK1_dF, dphase_flux_dF,
     &     dphase_flux_dgrad_phi, dphase_flux_dphi,
     &     dphase_storage_dF, dphase_storage_dc,
     &     dphase_storage_dphi, dspecies_flux_dF,
     &     dspecies_flux_dgrad_c, dspecies_flux_dgrad_phi,
     &     dspecies_flux_dphi, dspecies_storage_dF,
     &     dspecies_storage_dc)
...
C       dphase_flux_dF (sign=-1, grad-grad)
        DO ii_v = 1, 8
          DO jj_v = 1, 8
            DO k = 1, ndim
              col = edof_u(k, jj_v)
...
C       dphase_storage_dF (sign=+1, value-grad)
        DO ii_v = 1, 8
          DO jj_v = 1, 8
            row = edof_phi(ii_v)
            DO k = 1, ndim
...
C       dphase_storage_dc (sign=+1, value-value)
        DO ii_v = 1, 8
          DO jj_v = 1, 8
            row = edof_phi(ii_v)
            col = edof_c(jj_v)
...
C       dspecies_flux_dF (sign=-1, grad-grad)
        DO ii_v = 1, 8
          DO jj_v = 1, 8
            DO k = 1, ndim
              col = edof_u(k, jj_v)
...
C       dspecies_flux_dgrad_phi (sign=-1, grad-grad)
        DO ii_v = 1, 8
          DO jj_v = 1, 8
            row = edof_c(ii_v)
            col = edof_phi(jj_v)
...
C       dspecies_flux_dphi (sign=-1, grad-value)
        DO ii_v = 1, 8
          DO jj_v = 1, 8
            row = edof_c(ii_v)
            col = edof_phi(jj_v)
...
C       dspecies_storage_dF (sign=+1, value-grad)
        DO ii_v = 1, 8
          DO jj_v = 1, 8
            row = edof_c(ii_v)
            DO k = 1, ndim
...
C======================================================================
      SUBROUTINE cuij2corrosionmaterial_stress_PK1(F, phi, ep_old,
     ...
     &(DCMPLX(2.000000000000000d+00, 0.0d0) * phi)))
      xkap = DCMPLX(1.000000000000000d-03, 0.0d0)
...
C     --- Copy state outputs ---
      ...
      RETURN
      END SUBROUTINE cuij2corrosionmaterial_stress_PK1

      SUBROUTINE cuij2corrosionmaterial_phase_flux(F, phi, grad_phi,
     &props, phase_flux_out)
      ...
      RETURN
      END SUBROUTINE cuij2corrosionmaterial_phase_flux

      SUBROUTINE cuij2corrosionmaterial_phase_storage(F, phi, c,
     ...
     &(DCMPLX(2.000000000000000d+00, 0.0d0) * phi)))
      ...
      RETURN
      END SUBROUTINE cuij2corrosionmaterial_phase_storage

      SUBROUTINE cuij2corrosionmaterial_species_flux(F, phi, grad_phi,
     &grad_c, props, species_flux_out)
      IMPLICIT NONE
      DOUBLE COMPLEX, INTENT(IN) :: F(3,3)
      DOUBLE COMPLEX, INTENT(IN) :: phi
      DOUBLE COMPLEX, INTENT(IN) :: grad_phi(3)
     ...
     &(grad_c(ii) - ((dc_eq * dh) * grad_phi(ii))))
      ...
      RETURN
      END SUBROUTINE cuij2corrosionmaterial_species_flux

      SUBROUTINE cuij2corrosionmaterial_species_storage(F, c, c_old, dt,
     & props, species_storage_out)
      IMPLICIT NONE
      DOUBLE COMPLEX, INTENT(IN) :: F(3,3)
      DOUBLE COMPLEX, INTENT(IN) :: c
      ...
      RETURN
      END SUBROUTINE cuij2corrosionmaterial_species_storage


C======================================================================
C     Section 3: Complex-step tangent engine
C======================================================================
      SUBROUTINE cuij2corrosionmaterial_cs_tangents(
     &   F, c, phi, grad_c, grad_phi, F_old, phi_old, c_old,
     &   ep_old, epsp_old, deqpl_old, hydro_old, xL_old, ti_old,
     &   ei_old, props, dt, dPK1_dF, dphase_flux_dF,
     &   dphase_flux_dgrad_phi, dphase_flux_dphi,
     &   dphase_storage_dF, dphase_storage_dc,
     &   dphase_storage_dphi, dspecies_flux_dF,
     &   dspecies_flux_dgrad_c, dspecies_flux_dgrad_phi,
...
C     --- Outputs (all DOUBLE PRECISION) ---
      ...
      DOUBLE PRECISION, INTENT(OUT) :: dphase_flux_dF(3,3,3)
      DOUBLE PRECISION, INTENT(OUT) :: dphase_flux_dgrad_phi(3,3)
      DOUBLE PRECISION, INTENT(OUT) :: dphase_flux_dphi(3)
      DOUBLE PRECISION, INTENT(OUT) :: dphase_storage_dF(3,3)
      DOUBLE PRECISION, INTENT(OUT) :: dphase_storage_dc
      DOUBLE PRECISION, INTENT(OUT) :: dphase_storage_dphi
      DOUBLE PRECISION, INTENT(OUT) :: dspecies_flux_dF(3,3,3)
      DOUBLE PRECISION, INTENT(OUT) :: dspecies_flux_dgrad_c(3,3)
      DOUBLE PRECISION, INTENT(OUT) :: dspecies_flux_dgrad_phi(3,3)
      DOUBLE PRECISION, INTENT(OUT) :: dspecies_flux_dphi(3)
      DOUBLE PRECISION, INTENT(OUT) :: dspecies_storage_dF(3,3)
...
C     === dPK1_dF: d(stress_PK1)/d(F) ===
      DO k = 1, 3
        DO l = 1, 3
          ...
          CALL cuij2corrosionmaterial_stress_PK1(Fz, phiz, ep_old_z,
     &epsp_old_z, deqpl_old_z, hydro_old_z, xL_old_z, ti_old_z,
...
C     === dphase_flux_dF: d(phase_flux)/d(F) ===
      DO k = 1, 3
        DO l = 1, 3
          CALL real2complex33(F, Fz)
          cz = DCMPLX(c, 0.0d0)
          ...
          ei_old_z = DCMPLX(ei_old, 0.0d0)
          Fz(k,l) = Fz(k,l) + DCMPLX(0.0d0, CS_H)
          CALL cuij2corrosionmaterial_phase_flux(Fz, phiz, grad_phi_z,
     &props, jRz)
          DO i = 1, 3
            dphase_flux_dF(i,k,l) = AIMAG(jRz(i)) / CS_H
          END DO
        END DO
      END DO
...
C     === dphase_storage_dF: d(phase_storage)/d(F) ===
      DO k = 1, 3
        DO l = 1, 3
          CALL real2complex33(F, Fz)
          cz = DCMPLX(c, 0.0d0)
          ...
          ei_old_z = DCMPLX(ei_old, 0.0d0)
          Fz(k,l) = Fz(k,l) + DCMPLX(0.0d0, CS_H)
          CALL cuij2corrosionmaterial_phase_storage(Fz, phiz, cz,
     &phi_old_z, xL_old_z, dt, props, cdotz)
          dphase_storage_dF(k,l) = AIMAG(cdotz) / CS_H
        END DO
      END DO

C     === dphase_storage_dc: d(phase_storage)/d(c) ===
      CALL real2complex33(F, Fz)
      cz = DCMPLX(c, CS_H)
      phiz = DCMPLX(phi, 0.0d0)
      CALL real2complex3(grad_c, grad_c_z)
      ...
      ti_old_z = DCMPLX(ti_old, 0.0d0)
      ei_old_z = DCMPLX(ei_old, 0.0d0)
      CALL cuij2corrosionmaterial_phase_storage(Fz, phiz, cz, phi_old_z,
     & xL_old_z, dt, props, cdotz)
      dphase_storage_dc = AIMAG(cdotz) / CS_H
...
C     === dspecies_flux_dF: d(species_flux)/d(F) ===
      DO k = 1, 3
        DO l = 1, 3
          CALL real2complex33(F, Fz)
          cz = DCMPLX(c, 0.0d0)
          ...
          ei_old_z = DCMPLX(ei_old, 0.0d0)
          Fz(k,l) = Fz(k,l) + DCMPLX(0.0d0, CS_H)
          CALL cuij2corrosionmaterial_species_flux(Fz, phiz, grad_phi_z,
     & grad_c_z, props, jRz)
          DO i = 1, 3
            dspecies_flux_dF(i,k,l) = AIMAG(jRz(i)) / CS_H
          END DO
        END DO
      END DO
...
C     === dspecies_flux_dgrad_phi: d(species_flux)/d(grad_phi) ===
      DO k = 1, 3
        CALL real2complex33(F, Fz)
        cz = DCMPLX(c, 0.0d0)
        phiz = DCMPLX(phi, 0.0d0)
     ...
     &grad_c_z, props, jRz)
        DO i = 1, 3
          dspecies_flux_dgrad_phi(i,k) = AIMAG(jRz(i)) / CS_H
        END DO
      END DO

C     === dspecies_flux_dphi: d(species_flux)/d(phi) ===
      CALL real2complex33(F, Fz)
      cz = DCMPLX(c, 0.0d0)
      phiz = DCMPLX(phi, CS_H)
      CALL real2complex3(grad_c, grad_c_z)
     ...
     &grad_c_z, props, jRz)
      DO i = 1, 3
        dspecies_flux_dphi(i) = AIMAG(jRz(i)) / CS_H
      END DO

C     === dspecies_storage_dF: d(species_storage)/d(F) ===
      DO k = 1, 3
        DO l = 1, 3
          CALL real2complex33(F, Fz)
          cz = DCMPLX(c, 0.0d0)
          ...
          ei_old_z = DCMPLX(ei_old, 0.0d0)
          Fz(k,l) = Fz(k,l) + DCMPLX(0.0d0, CS_H)
          CALL cuij2corrosionmaterial_species_storage(Fz, cz, c_old_z,
     &dt, props, cdotz)
          dspecies_storage_dF(k,l) = AIMAG(cdotz) / CS_H
        END DO
      END DO
...
C     === dspecies_storage_dc: d(species_storage)/d(c) ===
      ...
      ti_old_z = DCMPLX(ti_old, 0.0d0)
      ei_old_z = DCMPLX(ei_old, 0.0d0)
      CALL cuij2corrosionmaterial_species_storage(Fz, cz, c_old_z, dt,
     &props, cdotz)
      dspecies_storage_dc = AIMAG(cdotz) / CS_H

      RETURN
      END SUBROUTINE cuij2corrosionmaterial_cs_tangents
