...
C     Material: ThermoMechanicalMaterial
C     Fields: u, T
...
C       Real material evaluation (for RHS)
        ...
        CALL thermomechanicalmaterial_stress_PK1(Fz_r, Tz_r, PROPS,
     &Pz_eval)
        DO i = 1, 3
          DO j = 1, 3
          ...
          END DO
        END DO
        CALL thermomechanicalmaterial_solvent_flux(Fz_r, Tz_r, grad_T_r,
     & PROPS, jRz_eval)
        DO i = 1, 3
          jR_real(i) = DBLE(jRz_eval(i))
        END DO
        CALL thermomechanicalmaterial_solvent_storage(Fz_r, Fold_r,
     &Tz_r, DCMPLX(T_old_gp, 0.0d0), dt_safe, PROPS, cdotz_eval)
        cdot_real = DBLE(cdotz_eval)

C       CS tangent engine
        CALL thermomechanicalmaterial_cs_tangents(F, T_gp, grad_T,
...
C======================================================================
      SUBROUTINE thermomechanicalmaterial_stress_PK1(F, T, props, P_out)
      IMPLICIT NONE
     ...
     &0.0d0)) * T) * finv_t)
      ...
      RETURN
      END SUBROUTINE thermomechanicalmaterial_stress_PK1

      SUBROUTINE thermomechanicalmaterial_solvent_flux(F, T, grad_T,
     &props, jR_out)
      IMPLICIT NONE
      DOUBLE COMPLEX, INTENT(IN) :: F(3,3)
      DOUBLE COMPLEX, INTENT(IN) :: T
      ...
      Cinv = INV3
      CALL matvec33z(Cinv, grad_T, MM4)

      DO ii = 1, 3
        jR_out(ii) = ((-DCMPLX(props(4), 0.0d0)) * MM4(ii))
      END DO

      RETURN
      END SUBROUTINE thermomechanicalmaterial_solvent_flux

      SUBROUTINE thermomechanicalmaterial_solvent_storage(F, F_old, T,
     &T_old, dt, props, cdot_out)
      ...
      RETURN
      END SUBROUTINE thermomechanicalmaterial_solvent_storage


C======================================================================
C     Section 3: Complex-step tangent engine
C======================================================================
      SUBROUTINE thermomechanicalmaterial_cs_tangents(
...
C     === dPK1_dF: d(stress_PK1)/d(F) ===
      DO k = 1, 3
        DO l = 1, 3
          ...
          CALL thermomechanicalmaterial_stress_PK1(Fz, Tz, props, PKz)
          DO i = 1, 3
            DO j = 1, 3
...
C     === dflux_dF: d(solvent_flux)/d(F) ===
      DO k = 1, 3
        DO l = 1, 3
          ...
          CALL real2complex3(grad_T, grad_T_z)
          Fz(k,l) = Fz(k,l) + DCMPLX(0.0d0, CS_H)
          CALL thermomechanicalmaterial_solvent_flux(Fz, Tz, grad_T_z,
     &props, jRz)
          DO i = 1, 3
...
C     === dstorage_dF: d(solvent_storage)/d(F) ===
      DO k = 1, 3
        DO l = 1, 3
          ...
          CALL real2complex3(grad_T, grad_T_z)
          Fz(k,l) = Fz(k,l) + DCMPLX(0.0d0, CS_H)
          CALL thermomechanicalmaterial_solvent_storage(Fz, F_old_z, Tz,
...
C     === dstorage_dT: d(solvent_storage)/d(T) ===
     ...
     &T_old_z, dt, props, cdotz)
      ...
      RETURN
      END SUBROUTINE thermomechanicalmaterial_cs_tangents
