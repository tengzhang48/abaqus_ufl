...
C     Material: TemplateElastic
C     Update method: stress_update
C     Algorithmic tangent: major-symmetric
C     Props: G=10.0, lam=20.0
C     NPROPS = 2
C
C       abaqus job=my_job user=template_umat.for
C======================================================================
...
C     Generated by abaqus_ufl for material: templateelastic
C     NPROPS = 2
C======================================================================
...
C     --- Real stress update ---
      ...
      CALL templateelastic_stress_update(sigma_old_z,
     &  strain_old_z,
     &  dstrain_z,
     &  cutback_z,
     &  PROPS,
...
C======================================================================
C     Section 2: Material stress update: templateelastic_stress_update
C======================================================================
      SUBROUTINE templateelastic_stress_update(sigma_old, strain_old,
     &dstrain, cutback_flag, props, sigma_new)
      IMPLICIT NONE
      ...
      DO ii = 1, 3
        DO jj = 1, 3
          sigma_new(ii,jj) = ((sigma_old(ii,jj) +
     &((DCMPLX(2.000000000000000d+00, 0.0d0) * DCMPLX(props(1), 0.0d0))
     &* dstrain(ii,jj))) + ((DCMPLX(props(2), 0.0d0) * (dstrain(1,1)+
     &dstrain(2,2)+dstrain(3,3))) * I(ii,jj)))
        END DO
      END DO

      RETURN
      END SUBROUTINE templateelastic_stress_update
