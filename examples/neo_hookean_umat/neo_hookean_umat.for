...
C
C     Generated by abaqus_ufl for material: neohookean
C     NPROPS = 2
C======================================================================
...
C     --- Compute dP/dF via complex step ---
      CALL neohookean_cs_dPdF(F, PROPS, dPdF)
...
C======================================================================
C     Section 2: Material stress: neohookean_stress_PK1
C======================================================================
...
C======================================================================
      SUBROUTINE neohookean_cs_dPdF(F, props, dPdF)
      IMPLICIT NONE
      ...
      RETURN
      END SUBROUTINE neohookean_cs_dPdF
